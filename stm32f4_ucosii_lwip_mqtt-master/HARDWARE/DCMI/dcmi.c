...
{ 
  ...
  {
	  printf("双缓冲模式\r\n");
	   DMA_DoubleBufferModeConfig(DMA2_Stream1,DMA_Memory1BaseAddr,DMA_Memory_0);
...
void My_DCMI_Init(void)
{
  ...
  GPIO_Init(GPIOE, &GPIO_InitStructure);//初始化	
    ...
    DCMI_InitStructure.DCMI_CaptureMode=DCMI_CaptureMode_SnapShot;//DCMI_CaptureMode_Continuous;//连续模式
